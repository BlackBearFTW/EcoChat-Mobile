...
class MarkerEditor extends StatelessWidget {
  ...
  final void Function(MarkerModel marker) onComplete;
  final void Function() onCancel;

  MarkerEditor({Key? key, required this.marker, required this.onComplete, required this.onCancel}) : super(key: key);
